...
const runtimeAttributionFields = {
  ...
  external_user_id: z
    ...
    .optional()
    .describe(
      'Stable per-end-user identifier for Gravity attribution. Codewolf usually fills this automatically.',
    ),
  metadata: jsonObjectSchema
    .optional()
    .describe(
      'Non-sensitive API key metadata for Gravity attribution and debugging. Codewolf usually fills this automatically.',
    ),
}
