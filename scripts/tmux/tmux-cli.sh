...
#   and stopping test sessions. Works with any TUI app (Codewolf,
...
#
#   # Test Codewolf (default when no --command specified)
...
#   ./scripts/tmux/tmux-cli.sh stop "$SESSION"
#
#   # Test a compiled Codewolf binary
#   SESSION=$(./scripts/tmux/tmux-cli.sh start --binary)
#   # Or with custom path:
#   SESSION=$(./scripts/tmux/tmux-cli.sh start --binary ./path/to/codewolf)
#
