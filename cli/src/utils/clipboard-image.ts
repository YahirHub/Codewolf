...
function readImageMacOS(): ClipboardImageResult {
  try {
    ...
    return {
      success: false,
      error: result.stderr || 'No se pudo leer la imagen del portapapeles',
    }
  } catch (error) {
    return {
      success: false,
...
function readImageLinux(): ClipboardImageResult {
  try {
    ...
    return {
      success: false,
      error: 'No se encontró una imagen en el portapapeles o no se pudo leer',
    }
  } catch (error) {
    return {
      success: false,
...
function readImageWindows(): ClipboardImageResult {
  try {
    ...
    return {
      success: false,
      error: 'No hay una imagen en el portapapeles o no se pudo guardar',
    }
  } catch (error) {
    return {
      success: false,
